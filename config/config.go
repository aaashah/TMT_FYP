...
type Config struct {
	...
	ASMThreshold            float64 `json:"ASMThreshold"`
	Debug                   bool    `json:"-"`
	Seed                    int64   `json:"-"`
}
...
func NewConfig() Config {
	...
	flag.IntVar(&cfg.NumTurns, "turns", 50, "Initial number of turns")
	...
	flag.Float64Var(&cfg.ASMThreshold, "tau", 0.5, "Threshold for ASM decision")
